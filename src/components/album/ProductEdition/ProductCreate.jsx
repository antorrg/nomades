                    ...
                    <div className="container mt-5">
                        ...
                        <section className="needs-validation" id="updateForm" noValidate>
                                    ...
                                    <div key={index}>
                                        <div>
                                            ...
                                            <ImageUploader
                                                ...
                                                titleField=""
                                                imageValue={item.img}
                                                onImageUpload={(url) => handleItemImageChange(index, url)}
                                            />
                                        </div>
                                        <div>
                            ...
                            <div className="d-flex flex-row me-3">
                                <GenericButton className="btn btn-outline-success mb-3 me-2" type="button" onClick={addItem} buttonText="Agregar Item" />
                                <GenericButton className="btn btn-secondary mb-3 me-2" buttonText="Cancelar" onClick={onClose} />
                                <GenericButton className="btn btn-primary mb-3 me-2" type="button" onClick={handleSubmit} buttonText="Enviar" />
                            </div>
                        </section>
                    </div>
                </div>
