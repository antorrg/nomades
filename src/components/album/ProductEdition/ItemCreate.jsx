                    ...
                    <div className="container mt-5">
                        ...
                        <section className="needs-validation" id="updateForm" noValidate>
                            ...
                            <div className="d-flex flex-row me-3">
                                <GenericButton className="btn btn-secondary mb-3 me-2" buttonText="Cancelar" onClick={itemOnClose} />
                                <GenericButton className="btn btn-primary mb-3 me-2" type="button" onClick={handleSubmit} buttonText="Crear" />
                            </div>
                        </section>
                    </div>
                </div>
