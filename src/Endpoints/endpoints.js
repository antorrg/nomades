...
const userLogin = new BaseEndpoints("/api/v1/user", false);
...
export const userValid = new BaseEndpoints("/api/v1/user", true); 
...
export const landingGetById = (id) =>
  landingAdmin.get(`${id}`, null, null);
...
const itemAdmin = new BaseEndpoints("/api/v1/product/item", true);
...
export const userVerify = (data, aux, auxReject) =>
  userValid.post("update", data, aux, auxReject);
...
export const userUpgrade = (id, data, aux, auxReject) =>
  userValid.put(`upgrade/${id}`, data, aux, auxReject, '¡Actualizacion de usuario exitosa!');

export const userResetPass = (id, data, aux, auxReject) =>
  userValid.put(`reset/${id}`, data, aux,  auxReject, '¡Contraseña reinicida exitosamente!');
...
const workAdmin = new BaseEndpoints("/api/v1/work", true);

export const createWorks = (data, aux, auxReject) => workAdmin.post(`create`, data,  aux, auxReject)
